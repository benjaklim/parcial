...
def con_T(dinosaurios):
    return [dino["nombre"] for dino in dinosaurios if dino["nombre"].startswith("T")]

def menos_275kg(dinosaurios):
    return [dino["nombre"] for dino in dinosaurios if int(dino["peso"].split()[0]) < 275]

def con_AQS(dinosaurios):
    pila = []
    for dino in dinosaurios:
        if dino["nombre"].startswith(("A", "Q", "S")):
            pila.append(dino["nombre"])
    return pila

print("a) Cantidad de especies:", especies(dinosaurios))
print("b) Cantidad de descubridores distintos:", descubridores(dinosaurios))
print("c) Dinosaurios que empiezan con T:", con_T(dinosaurios))
print("d) Dinosaurios que pesan menos de 275 Kg:", menos_275kg(dinosaurios))
print("e) Dinosaurios que comienzan con A, Q, S:", con_AQS(dinosaurios))